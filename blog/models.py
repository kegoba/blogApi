...
class Comments(models.Model):
    ...
    post_id = models.ForeignKey(Post, null=True, related_name="post_id", on_delete=models.CASCADE)
...
class Share(models.Model):
    ...
    post = models.ForeignKey(Post, null=True, related_name="post_share", on_delete=models.CASCADE)
